...
export const isMutexLocked = _it => {
  var _getSharedGlobalVaria, _getSharedGlobalVaria2;

  return !!((_getSharedGlobalVaria = getSharedGlobalVariable(KEY_MUTEXES, {})) !== null && _getSharedGlobalVaria !== void 0 && (_getSharedGlobalVaria2 = _getSharedGlobalVaria[_it]) !== null && _getSharedGlobalVaria2 !== void 0 && _getSharedGlobalVaria2.currentHolder);
};
/**
...
export const requestMutex = async (mutexCode, {
