...
export const getUniqueKey = _arg => {
...
export const bumpGlobalCounter = key => updateSharedGlobalVariable(`__counter::${key}__`, _arg2 => {
  return _arg2 + 1;
}, 0);
/**
 * @type {string}
...
export const overrideGlobalFunction = (name, applyOverride, overrideVersion = 1) => onceGlobalDefined(name, isFunction, () => overrideFunction(window, name, applyOverride, overrideVersion), 'global', overrideVersion);
/**
...
export const overrideStaticMethod = (constructorName, methodName, applyOverride, overrideVersion = 1) => onceGlobalDefined(constructorName, isFunction, _arg3 => {
  return overrideFunction(_arg3, methodName, applyOverride, overrideVersion);
}, `static_method:${methodName}`, overrideVersion);
/**
...
export const overrideInstanceMethod = (constructorName, methodName, applyOverride, overrideVersion = 1) => onceGlobalDefined(constructorName, isFunction, _arg4 => {
...
export const onConstructorCall = (name, callback, listenerId, listenerVersion = 1) => overrideGlobalFunction(name, constructor => function (...data) {
  if (!new.target) {
